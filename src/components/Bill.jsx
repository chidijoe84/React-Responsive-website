        ...
        <h2 className={styles.heading2}>Easily control your <br
         className='sm:block hidden'/> billing & invoicing.</h2>
          <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
            ...
            adipisicing elit. Aliquid reiciendis inventore
             nulla atque earum sint velit? Obcaecati tenetur
              sint eligendi amet nihil illo, possimus quos 
              animi, delectus doloremque pariatur quidem.
          </p>
